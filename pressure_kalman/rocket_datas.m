...
Sensor_pressure_noise_mag = .1; %process noise: the variability in how fast the Quail is speeding up (stdv of acceleration: meters/sec^2)
arduino_noise_mag = .01;  %measurement noise: How mask-blinded is the Ninja (stdv of location, in meters)
